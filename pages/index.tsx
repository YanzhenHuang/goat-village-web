      ...
      <section className={`flex flex-row pl-5 py-16 items-center justify-around w-full min-h-[50vh]`}>
        <div className={`flex flex-col text-left w-[60vh] gap-5`}>
          ...
          <p className={`text-[1.2rem] whitespace-pre-line`}>
            ...
            直到大二下学期，李若璇的加入后，羊村内部开始形成向心力，团队正式确定名称为“羊村”。该学期也是疫情结束后的第一个学期，大家出去玩的次数也多了。
            
            最后，郭芃泽在大三上正式进入羊村，羊村当前的格局正式确立下来。此后，羊村在该五人的基础上蓬勃发展。
        ...
        <ImageGallery
          ...
          imageFileNames={[`yangzhihan.jpg`, `all.jpg`, `chenzirui_chill.jpg`, `liruoxuan.jpg`, `miniso.jpg`, `bob_pizza.jpg`]} />
      </section>
    </main>
  );
}
